...
const TimelineContent: React.FC = () => {
  ...
  const events15 = [
    ...
    { time: '09:00 PM - 10:00 PM', eventName: 'Band Sound Check'},
    { time: '09:00 PM - 10:00 PM', eventName: 'Faculty Award Night'},
  ...
  return (
    <>
        ...
        <EventItem key={index} time={event.time} eventName={event.eventName} url={event.url || "javascript:void(0)"} />
          ...
          <div className='flex flex-col absolute mt-[160vw] top-[35.5%] left-[44.5%] sm:top-[2.5%] sm:left-[10%]'>
