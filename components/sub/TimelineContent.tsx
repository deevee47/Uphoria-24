...
const TimelineContent: React.FC = () => {
  ...
  const events15 = [
    ...
    { time: '12:00 PM - 06:00 PM', eventName: 'FIFA',  url: ''},
    ...
    { time: '02:30 PM - 05:00 PM', eventName: 'Band Sound Check',  url: ''},
    { time: '05:00 PM - 08:00 PM', eventName: 'Faculty Award Night',  url: ''},
    { time: '09:00 PM - 10:00 PM', eventName: 'Prom Night',  url: ''},
    { time: '10:00 PM - 12:00 AM', eventName: 'Band Night',  url: ''},
  ...
  const events16 = [
    ...
    { time: '4:00 PM - 06:00 PM', eventName: 'Clay Art',  url: ''},
    ...
    { time: '11:00 AM - 04:00 PM', eventName: 'BGMI',  url: ''},
    { time: '4:00 PM - 09:00 PM', eventName: 'CODM',  url: ''},
    ...
    { time: '10:00 PM - 12:00 AM', eventName: 'DJ Night',  url: ''},
  ...
  const events17 = [
    ...
    { time: '11:00 AM - 06:00 PM', eventName: 'Valorant Premieare League', url: ''},
  ...
  return (
    <>
        ...
        {events15.map((event, index) => (
          ...
          <div className='flex flex-col  absolute mt-[90vw] top-[21%] left-[44.5%] sm:top-[12%] sm:left-[10%]'>
