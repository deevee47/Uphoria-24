...
const FooterContent = () => {
  return (
    ...
    <Image className="animate-pulse absolute  w-[60%] sm:w-[30%] -top-[30%] left-[50%] sm:-top-[55%] sm:left-[70%]" src="fullGoldMandala.svg" alt="Golden Mandala" width={350} height={60} />
