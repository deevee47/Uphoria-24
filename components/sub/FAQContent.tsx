...
const FAQContent = () => {
  return (
        <motion.div initial= "hidden" animate= "visible" className='h-full w-full flex flex-col items-center md:justify-center sm:mb-[5vw] mb-[12vw]'>
            <div id="contact" className='contact-us w-full flex flex-col md:justify-center text-center items-center pt-[24vw] pb-[14vw] '>
                ...
                <div className='contact-us-mails text-[#F6DFAD] sm:text-[2vw] text-[3vw] font-bold underline'><a href="mailto:support@bu-fest.in">support@bu-fest.in</a><br></br><a href="mailto:uphoria@bennett.edu.in">uphoria@bennett.edu.in</a></div>
            </div>
