...
const FAQContent = () => {
  return (
        <motion.div initial= "hidden" animate= "visible" className='h-full w-full flex flex-col items-center md:justify-center'>
            <div className='contact-us w-full flex flex-col md:justify-center text-center items-center py-[14vw]'>
                ...
                <div className='contact-us-mails text-[#F6DFAD] sm:text-[2vw] text-[3vw] font-bold'>support@bu-fest.in<br></br>uphoria.zenevia@bennett.edu.in </div>
            </div>
            <div className='FAQHeading text-[5.8vw] sm:text-[4vw] text-[#FFAD0E] font-normal w-full text-center'>
